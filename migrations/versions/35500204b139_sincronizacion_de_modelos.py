...
Revision ID: 35500204b139
Revises: 
Create Date: 2026-08-13 16:48:54.037377
...
def upgrade():
    ...
    with op.batch_alter_table('configuracion_empresa', schema=None) as batch_op:
        batch_op.add_column(sa.Column('margen_ganancia_unidad', sa.Numeric(precision=10, scale=2), nullable=False))
...
def downgrade():
    ...
    with op.batch_alter_table('configuracion_empresa', schema=None) as batch_op:
        ...
        batch_op.drop_column('margen_ganancia_unidad')
